...
const enterChart = ref(null);
let zoomEnterChart = null;
...
const getOptions = () =>{
	...
	zoomEnterChart.setOption(option.value);
...
*/
 ...
 onMounted(
	async () => {
		...
		await nextTick();
		zoomEnterChart = echarts.init(enterChart.value);
...
<template>
  <h1 class="text-2xl text-center">Enter and Exit</h1>
  <div
    id="mainland"
    class="chart"
	ref= "enterChart"
