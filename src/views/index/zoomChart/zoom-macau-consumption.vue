<template>
	<h1 class="text-2xl text-center">Macau Consumption</h1>
  <div class="container">
    <el-slider
      ...
      show-tooltip
      @change="onYearChange"
      style="height: 400px; width: 10px; font-size:12px; color: grey;"
      vertical
      class="vertical-slider"
    ></el-slider>
    <div id= "zoomConsumptionChart" ref="zoomChartContainer"></div>
  </div>
  <el-button class="button" size="small" @click="toggleCarousel">
...
export default {
  ...
  methods: {
    ...
    showDataForYear(year) {
	  ...
	  const myChart = echarts.init(this.$refs.zoomChartContainer);
